public class LinearArray{
  ...
  public static void printReverse(int [] source){
   ...
   for(int sp=source.length-1;sp>=0;sp--)
    System.out.print(source[sp]+" ");
   System.out.println();
  }
  ...
  public static boolean insert(int [] arr, int size, int elem, int index){
    ...
    System.out.println("Number of elements after insertion: "+c);
     f=true;
    }
